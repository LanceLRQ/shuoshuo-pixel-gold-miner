...
根因：旧 `mineralBudgetRatio` 是**全矿物总价值**保底，里面混了 BONE/STONE/MOUSE 等低价垃圾。配合 `largeWeightScale=0.10/0.0`（高难度大金块几乎不生成），场上确实有"足够总值"但**金块比例极低**，玩家看到的多是石头猪子，真正能"刷钱"的金块总额低于 target，导致抓不完也不达标。
