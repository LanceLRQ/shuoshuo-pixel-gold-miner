...
> ⚠️ **本文档已被取代**：服务端（shuoshuo-crystal 开放平台游戏运行时）实装后协议已变化，
> 正式开发文档见 [20260605_leaderboard-server-integration.md](./20260605_leaderboard-server-integration.md)。
> 本文仅保留作设计演进记录（D1-D5 决策仍部分有效，差异对照见新文档 §1.2）。
